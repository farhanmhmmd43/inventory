...
class Service extends Component {
  ...
  get_listview = (state, instance, customFilter = []) => {
    ...
    axios({
      ...
      url: 'api/v1/cms/get-all-promoservice',
      params,
      headers: {
  ...
  get_desc = (id) => axios({
    method: 'POST',
    baseURL: this.props.variables.api_url,
    url: 'api/v1/cms/get-desc-promoservice',
    headers: {
      "Content-Type": "application/json",
      "Authorization": "Bearer " + this.props.userData.access_token
    },
  ...
  update_desc = () => {
    ...
    axios({
      method: 'POST',
      baseURL: this.props.variables.api_url,
      url: 'api/v1/cms/update-desc-promoservice',
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer " + this.props.userData.access_token
      },
  ...
  get_sk = (id) => axios({
    method: 'POST',
    baseURL: this.props.variables.api_url,
    url: 'api/v1/cms/get-sk-promoservice',
    headers: {
      "Content-Type": "application/json",
      "Authorization": "Bearer " + this.props.userData.access_token
    },
  ...
  update_sk = () => {
    ...
    axios({
      method: 'POST',
      baseURL: this.props.variables.api_url,
      url: 'api/v1/cms/update-sk-promoservice',
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer " + this.props.userData.access_token
      },
  ...
  get_note = (id) => axios({
    method: 'POST',
    baseURL: this.props.variables.api_url,
    url: 'api/v1/cms/get-note-promoservice',
    headers: {
      "Content-Type": "application/json",
      "Authorization": "Bearer " + this.props.userData.access_token
    },
  ...
  update_note = () => {
    ...
    axios({
      method: 'POST',
      baseURL: this.props.variables.api_url,
      url: 'api/v1/cms/update-note-promoservice',
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer " + this.props.userData.access_token
      },
  ...
  render() {
    return (
      <div className="animated fadeIn">
              ...
              <CardBody>
                <CustomTable
                  ...
                  buttons={[
                    {
                      type: 'upload',
                      url: 'api/v1/cms/upload-promoservice',
                      name: 'promoservice',
                      access: [1, 2]
                    }
                  ]}
        ...
        <Edit
          loading={this.state.loading}
          isOpen={this.state.modal_sk}
          onUpdate={this.update_sk}
          inputs={[
            {
              type: 'hidden',
              value: this.state.form_data.id,
