   ...
   render() {
      return (
         <Modal
            ...
            centered={true}
            size={"lg"}>
            <ModalHeader toggle={this.toggle_modal}>Add</ModalHeader>
            <ModalBody>
               <Row>
                     ...
                     if (v.type === 'hidden') {
                           ...
                           <Col xs={v.col} key={index}>
                              <FormGroup>
                                 ...
                                 <SelectSearch
                                    ...
                                    value={this.state.form_data[v.name] ? this.state.form_data[v.name] : v.value}
                        ...
                        return (
                           <Col xs={v.col} key={index}>
                              <FormGroup>
                                 <Label>{v.label}</Label>
                                 <Input type={v.type} name={v.name} onChange={this.fill_form_data} value={this.state.form_data[v.name] ? this.state.form_data[v.name] : v.value} invalid={false} >
